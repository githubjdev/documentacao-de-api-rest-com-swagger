...
public class GreetingsController {
	...
	@PostMapping(value = "salvar", produces = "application/json") /* mapeia a url */
	...
	@PutMapping(value = "atualizar", consumes = "application/json", produces = "application/json") /* mapeia a url */
	@ResponseBody /* Descricao da resposta */
	...
	@ApiOperation(value = "Busca o usuário por ID")
	@ApiResponses(value = {
